...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: _Bz3U4_u7Fi0/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__wnCcX)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__x84Ua, {
                [sty.imghideIcon__x84Ual1O75]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yRvJd)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__vxDkL, {
            [sty.freeBoxhideIcon__vxDkLl1O75]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__itBkV)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__sr08C, {
              [sty.freeBoxhideTrendTracker__sr08CrRm8R]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox___2HgWv, {
                [sty.freeBoxhideTrendTracker___2HgWvrRm8R]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__f0PRj)}>
                {p.renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__cPHzA)}>
              <div className={classNames(projectcss.all, sty.freeBox__p1KPv)}>
                {p.renderPlasmicSlot({
