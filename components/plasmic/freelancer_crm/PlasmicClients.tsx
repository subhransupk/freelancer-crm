...
import sty from "./PlasmicClients.module.css"; // plasmic-import: amdOCucwepJd/css
...
export const PlasmicClients__ArgProps = new Array<ArgPropType>("children");
