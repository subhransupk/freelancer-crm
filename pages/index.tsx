...
<li><Link href="/user/[__airtable_id]">LoginPage - /user/[__airtable_id]</Link></li>
<li><Link href="/clients">Clients - /clients</Link></li>
<li><Link href="/projects">Projects - /projects</Link></li>
<li><Link href="/leads">Leads - /leads</Link></li>
          </ul>
